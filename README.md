...
5. **Scrape and create dataset**: Interactively prompts for URLs and max pages per seed, then scrapes websites and generates sft_dataset.jsonl.
6. **Reduce dataset**: Interactively prompts for max lines and random sampling, then reduces the dataset size.
